...
static const std::vector<N64Song> kOotSongs = {
   ...
   { 0x21, "Boss Clear" }, { 0x26, "Inside Jabu-Jabu's Belly" },
   { 0x27, "Kakariko Village (Child)" }, { 0x28, "Great Fairy's Fountain" }, { 0x29, "Zelda's Theme" },
   { 0x2A, "Fire Temple" }, { 0x2C, "Forest Temple" },
   { 0x2D, "Hyrule Castle Courtyard" }, { 0x2E, "Ganon's Castle" }, { 0x2F, "Lon Lon Ranch" },
   { 0x30, "Goron City" }, { 0x31, "Hyrule Field Morning" }, { 0x38, "Mini-Boss Battle" },
   { 0x3A, "Temple of Time" }, { 0x3C, "Kokiri Forest" },
   { 0x3E, "Lost Woods" }, { 0x3F, "Spirit Temple" }, { 0x40, "Horse Race" },
   { 0x41, "Horse Race Goal" }, { 0x42, "Ingo's Theme" },
   { 0x4A, "Fairy Flying" }, { 0x4B, "Deku Tree" }, { 0x4C, "Windmill Hut" }, { 0x4D, "Legend of Hyrule" },
   { 0x4E, "Shooting Gallery" }, { 0x4F, "Sheik's Theme" }, { 0x50, "Zora's Domain" },
   { 0x52, "Goodbye to Zelda" }, { 0x53, "Master Sword" }, { 0x55, "Shop" },
   { 0x56, "Chamber of the Sages" }, { 0x57, "File Select" }, { 0x58, "Ice Cavern" },
   { 0x5B, "Shadow Temple" },
   { 0x5C, "Water Temple" }, { 0x5E, "Seal of Six Sages" },
